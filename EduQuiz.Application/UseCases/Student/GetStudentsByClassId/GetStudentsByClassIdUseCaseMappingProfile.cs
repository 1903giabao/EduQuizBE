...
{
    public class GetStudentsByClassIdUseCaseMappingProfile : Profile
    {
        public GetStudentsByClassIdUseCaseMappingProfile()
        {
            CreateMap<Domain.Entities.Student, GetStudentsByClassIdUseCaseOutput>()
